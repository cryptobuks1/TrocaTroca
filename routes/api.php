...
Route::group(['namespace' => 'api', 'as' => 'api.'], function () {
    ...
    Route::group(['middleware' => ['auth:api','jwt.refresh']], function () {
        ...
        Route::get('exchanges/all', 'ExchangeController@indexAll');
        ...
        Route::group(['middleware' => ['can:is_operator', 'can:is_super']], function () {
        ...
        Route::group(['middleware' => ['can:is_super', 'can:is_manager']], function () {
        ...
        Route::group(['middleware' => ['can:is_manager']], function () {
